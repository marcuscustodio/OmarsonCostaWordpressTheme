<?php get_header();?>
          ...
          <?php if($my_query_banner->have_posts()) : while($my_query_banner->have_posts() ) : $my_query_banner->the_post();?>
            ...
            <div class="col-md-6 col-lg-6 col-sm-12 text-abaout">
              ...
              <div class="buttons-about">
                <button type="button" class="btn btn-default fale-comigo " data-toggle="modal" data-target="#exampleModal"><a href="#">Newsletter</a></button>

                <button class="btn btn-default leia"><a href="http://omarson.com.br/contato">fale comigo</a></button>

                <button class="btn btn-default leia"><a href="http://omarson.com.br/artigos">leia meus artigos</a></button>
  ...
  <section class="posts-home">
    <div class="container">
      <ul class="nav nav-tabs" id="tab-home" role="tablist">
        <li class="nav-item">
          <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Artigos Recentes</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Mais Vistos</a>
        </li>
            ...
            <div class="container">
             ...
             <?php if($my_query->have_posts()) :
              ...
              ?>
                  ...
                  <div class="col-lg-4 col-md-6 col-xs-12 con">
                     <div class="card">
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
           <?php echo do_shortcode('[revue_subscribe]'); ?>
          </div>
